...
def generateEnemy(numberOfEnemy):
    for i in range(numberOfEnemy):
        ...
        if collision and enemyTags[i] != "":
            enemies[i] = pygame.image.load('hand-gesture-recognition-mediapipe-main\BlackBG.png')
            enemyX_change[i] = 0
            enemyTags[i] = ""
            global count
            count = count + 1
...
while showMenu:
        ...
        screen.blit(startText , (width/2.6,height/3))
        screen.blit(exitText,(width/4,height/2))
